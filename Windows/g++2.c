...
int main(int argc ,char *argv[])
{
    ...
    char s[2] = " ";
    if (argc==1){
        printf("""Introduction:-\n\tg++2 command make easily compile with run your program by only one command.\n"
                 "\tYou can save time in type gcc [filename].cpp -o [filename] and for run [filename].exe\n"
                 "Usage:-\n"
                 ...
                 "\tMake sure g++ compiler is already set up in you pc.\n"
                 ...
                 "\tType g++2 [filename without extension] and then press enter.\n"
